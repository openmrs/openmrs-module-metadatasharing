...
public class ConceptMergeHandler implements MetadataMergeHandler<Concept> {
	...
	private ConceptMergeLogic conceptMergeLogic;
	
	public void setConceptMergeLogic(ConceptMergeLogic conceptMergeLogic) {
		this.conceptMergeLogic = conceptMergeLogic;
	}
	...
	public void merge(Concept existingConcept, Concept incomingConcept, ImportType importType,
		...
		if (conceptMergeLogic == null) {
			conceptMergeLogic = new ConceptMerge16Logic(objectHandler);
		}
		
		conceptMergeLogic.merge(existingConcept, incomingConcept, importType, incomingToExisting);
	}
	...
	public static class ConceptMerge16Logic implements ConceptMergeLogic {
		
		private ObjectHandler objectHandler;
		
		public ConceptMerge16Logic(ObjectHandler objectHandler) {
