 ...
 */
@SuppressWarnings({ "unchecked", "rawtypes" }) //proprietary code
public class EnumType implements EnhancedUserType, ParameterizedType, Serializable {
	
	private static final long serialVersionUID = 1L;
	
	/**
	 * This is the old scheme where logging of parameter bindings and value extractions was
	 * controlled by the trace level enablement on the 'org.hibernate.type' package...
	 * <p/>
	 * Originally was cached such because of performance of looking up the logger each time in order
	 * to check the trace-enablement. Driving this via a central Log-specific class would alleviate
