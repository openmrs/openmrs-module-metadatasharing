...
public void shouldConvertCollectionToArrayList() {
    ...
    Collection<?> convertedCollection = new ArrayList<Object>(testCollection);
    
    assertTrue(convertedCollection instanceof ArrayList);
    assertEquals(2, convertedCollection.size());
}
}